...
let expr_operator_to_string op =
  match op with
  | ExprOperator.BinaryAdd -> "+"
  | ExprOperator.BinarySub -> "-"
  | ExprOperator.BinaryMul -> "*"
  | ExprOperator.BinaryDiv -> "/"
  | ExprOperator.BinaryMod -> "%"
  | ExprOperator.BinaryShl -> "<<"
  | ExprOperator.BinaryShr -> ">>"
  | ExprOperator.BinaryAnd -> "&"
  | ExprOperator.BinaryOr -> "|"
  | ExprOperator.BinaryXor -> "^"
  | ExprOperator.CompareEq -> "=="
  | ExprOperator.CompareNotEq -> "!="
  | ExprOperator.CompareLThan -> "<"
  | ExprOperator.CompareGThan -> ">"
  | ExprOperator.CompareLThanEq -> "<="
  | ExprOperator.CompareGThanEq -> ">="
  | ExprOperator.BooleanAnd -> "&&"
  | ExprOperator.BooleanOr -> "||"
  | ExprOperator.AssignEq -> "="
  | ExprOperator.AssignAddEq -> "+="
  | ExprOperator.AssignSubEq -> "-="
  | ExprOperator.AssignMulEq -> "*="
  | ExprOperator.AssignDivEq -> "/="
  | ExprOperator.AssignModEq -> "%="
  | ExprOperator.AssignShlEq -> "<<="
  | ExprOperator.AssignShrEq -> ">>="
  | ExprOperator.AssignAndEq -> "&="
  | ExprOperator.AssignOrEq -> "|="
  | ExprOperator.AssignXorEq -> "^="
  | ExprOperator.PrefixNot -> "~"
  | ExprOperator.PrefixBooleanNot -> "!"
  | ExprOperator.PrefixNegative -> "-"
  | ExprOperator.PrefixDereference -> "*"
  | ExprOperator.PrefixAddress -> "&"
