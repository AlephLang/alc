...
static String *to_string(const Alc_Ast *ast);
...
static void array_to_strings(String **children_vs_v, struct __Alc_Ast **asts, usize n)
{
  for (usize i = 0; i < n; i++) {
...
static void add_to_strings_opt(String **children_vs_v, const Alc_Ast *ast)
{
  if (ast == nullptr)
    return;
...
static String *to_string(const Alc_Ast *ast)
{
  ...
  case ALC_AST_KIND_ROOT: {
    String **children_vs_v = safe_reserve(String *, ast->data.ROOT.toplevel_statements_num);
  ...
  case ALC_AST_KIND_EXPR: {
    String **children_vs_v = vector_reserve(String *, 3);
  ...
  case ALC_AST_KIND_PREFIX_EXPR: {
    String **children_vs_v = vector_reserve(String *, 2);
  ...
  case ALC_AST_KIND_MODULE: {
    String **children_vs_v = vector_reserve(String *, 1);
    String header = string_create_from("MODULE { name: \"");
  ...
  case ALC_AST_KIND_TYPEDEF: {
    ...
    String header = string_create_from("TYPEDEF { name: \"");
  ...
  case ALC_AST_KIND_EXTERN_FUNC: {
    ...
    String header = string_create_from("EXTERN_FUNC { name: \"");
  ...
  case ALC_AST_KIND_EXTERN_VARDECL: {
    ...
    String header = string_create_from("EXTERN_VARDECL { name: \"");
  ...
  case ALC_AST_KIND_QUALIFIER: {
    ...
    String header = string_create_from("QUALIFIER { name: \"");
  ...
  case ALC_AST_KIND_NONE: {
    String *out_v = vector_reserve(String, 1);
  ...
  case ALC_AST_KIND_STRUCT: {
    String **children_vs_v = vector_reserve(String *, ast->data.STRUCT.children_num + 1);
    ...
    String header = string_create_from("STRUCT { name: \"");
  ...
  case ALC_AST_KIND_UNION: {
    String **children_vs_v = vector_reserve(String *, ast->data.UNION.children_num + 1);
    ...
    String header = string_create_from("UNION { name: \"");
  ...
  case ALC_AST_KIND_ENUM: {
    String **children_vs_v = vector_reserve(String *, ast->data.ENUM.elements_num + 1);
    ...
    String header = string_create_from("ENUM { name: \"");
  ...
  case ALC_AST_KIND_ENUM_ELEMENT: {
    ...
    String header = string_create_from("ENUM_ELEMENT { name: \"");
  ...
  case ALC_AST_KIND_FUNC: {
    String **children_vs_v = vector_reserve(String *, 4);
    ...
    String header = string_create_from("FUNC { name: \"");
  ...
  case ALC_AST_KIND_ARGUMENT_LIST: {
    String **children_vs_v = safe_reserve(String *, ast->data.ARGUMENT_LIST.arguments_num);
  ...
  case ALC_AST_KIND_NAMESPACE: {
    ...
    String header = string_create_from("NAMESPACE { name: \"");
  ...
  case ALC_AST_KIND_SCOPE: {
    String *out_v = vector_reserve(String, 1);
    String header = string_create_from("SCOPE { type: \"");
  ...
  case ALC_AST_KIND_CASE_CHAIN: {
    String **children_vs_v = vector_reserve(String *, ast->data.CASE_CHAIN.cases_num + 1);
  ...
  case ALC_AST_KIND_ATTRIBUTE: {
    String **children_vs_v = safe_reserve(String *, ast->data.ATTRIBUTE.arguments_num);
    array_to_strings(children_vs_v, ast->data.ATTRIBUTE.arguments,
                     ast->data.ATTRIBUTE.arguments_num);
    String header = string_create_from("ATTRIBUTE { name: \"");
  ...
  case ALC_AST_KIND_ATTRIBUTE_LIST: {
    String **children_vs_v = safe_reserve(String *, ast->data.ATTRIBUTE_LIST.attributes_num);
  ...
  case ALC_AST_KIND_EXPLICIT_CALL_ARGUMENT: {
    ...
    String header = string_create_from("EXPLICIT_CALL_ARGUMENT { name: \"");
  ...
  case ALC_AST_KIND_LABEL: {
    String *out_v = vector_reserve(String, 1);
    String header = string_create_from("LABEL { name: \"");
  ...
  case ALC_AST_KIND_STMT_BLOCK: {
    String **children_vs_v = safe_reserve(String *, ast->data.STMT_BLOCK.statements_num);
  ...
  case ALC_AST_KIND_STMT_FOR: {
    String **children_vs_v = vector_reserve(String *, 5);
  ...
  case ALC_AST_KIND_STMT_FOREACH: {
    ...
    String header = string_create_from("STMT_FOREACH { item_name: \"");
  ...
  case ALC_AST_KIND_STMT_SWITCH: {
    String **children_vs_v = vector_reserve(String *, ast->data.STMT_SWITCH.case_chains_num + 1);
  ...
  case ALC_AST_KIND_TYPE_PLAIN: {
    String *out_v = vector_reserve(String, 1);
    String header = string_create_from("TYPE_PLAIN { name: \"");
  ...
  case ALC_AST_KIND_VAR_DECL: {
    ...
    String header = string_create_from("VAR_DECL { name: \"");
  ...
  case ALC_AST_KIND_VAR_DEF: {
    ...
    String header = string_create_from("VAR_DEF { name: \"");
    string_append_cstr(&header, ast->data.VAR_DEF.name);
    string_append_cstr(&header, "\" }");
    return build_tree(header, children_vs_v);
  }
  ...
  case ALC_AST_KIND_EXPR_OPERAND_IDENTIFIER: {
    String *out_v = vector_reserve(String, 1);
    String header = string_create_from("EXPR_OPERAND_IDENTIFIER { name: \"");
  ...
  case ALC_AST_KIND_EXPR_OPERAND_CALL: {
    String **children_vs_v = safe_reserve(String *, ast->data.EXPR_OPERAND_CALL.arguments_num);
    array_to_strings(children_vs_v, ast->data.EXPR_OPERAND_CALL.arguments,
                     ast->data.EXPR_OPERAND_CALL.arguments_num);
    String header = string_create_from("EXPR_OPERAND_CALL { callee_name: \"");
  ...
  case ALC_AST_KIND_EXPR_OPERAND_GENERIC_CALL: {
    String **children_vs_v =
      vector_reserve(String *, ast->data.EXPR_OPERAND_GENERIC_CALL.arguments_num + 1);
    ...
    String header = string_create_from("EXPR_OPERAND_GENERIC_CALL { callee_name: \"");
  ...
  case ALC_AST_KIND_INITLIST: {
    String **children_vs_v = safe_reserve(String *, ast->data.INITLIST.entries_num);
  ...
  case ALC_AST_KIND_INITLIST_ENTRY_EXPLICIT: {
    ...
    String header = string_create_from("INITLIST_ENTRY_EXPLICIT { field_name: \"");
  ...
  case ALC_AST_KIND_INITLIST_ENTRY_EXPLICIT_ARRAY_ELEMENT: {
    String **children_vs_v = vector_reserve(
      String *, ast->data.INITLIST_ENTRY_EXPLICIT_ARRAY_ELEMENT.index_expressions_num + 1);
  ...
  case ALC_AST_KIND_GENERIC_STRUCT: {
    String **children_vs_v = vector_reserve(String *, ast->data.GENERIC_STRUCT.children_num + 2);
    ...
    String header = string_create_from("GENERIC_STRUCT { name: \"");
  ...
  case ALC_AST_KIND_GENERIC_FUNC: {
    ...
    String header = string_create_from("GENERIC_FUNC { name: \"");
  ...
  case ALC_AST_KIND_GENERIC_PLACEHOLDER_TYPE_LIST: {
    String **children_vs_v =
      safe_reserve(String *, ast->data.GENERIC_PLACEHOLDER_TYPE_LIST.generic_placeholder_types_num);
    array_to_strings(children_vs_v,
  ...
  case ALC_AST_KIND_GENERIC_PLACEHOLDER_TYPE: {
    ...
    String header = string_create_from("GENERIC_PLACEHOLDER_TYPE { name: \"");
  ...
  case ALC_AST_KIND_GENERIC_TYPE_LIST: {
    String **children_vs_v = safe_reserve(String *, ast->data.GENERIC_TYPE_LIST.generic_types_num);
  ...
  case ALC_AST_KIND_GENERIC_TYPE: {
    ...
    String header = string_create_from("GENERIC_TYPE { name: \"");
  ...
  case ALC_AST_KIND_GENERIC_NAMESPACE: {
    ...
    String header = string_create_from("GENERIC_NAMESPACE { name: \"");
